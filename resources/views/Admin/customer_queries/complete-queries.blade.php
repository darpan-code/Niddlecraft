...
@section('body')
    ...
    <div class="flex justify-between items-center mt-[6vw] mx-[5vw]">
        ...
        <div class="text-[2.2vw] font-bold">Complete</div>
    ...
    @for ($i = 1; $i <= 10; $i++)
        <div class="font-medium bg-[#ECECEC] min-h-[4vw] mb-[1vw] px-[1vw] rounded-[0.5vw] text-[1.2vw] w-[92vw]">
            <div class="flex justify-between pt-[0.5vw] font-medium">
                ...
                <div class="w-[4vw] flex justify-center cursor-pointer" id="show-btn{{$i}}".$i><i class="fa-solid fa-angle-down text-[2vw]" id="btn-icon{{$i}}"></i></div>
            </div>
            <div class="pb-[1vw] hidden" id="details{{$i}}">
        ...
        <script>
            $(document).ready(function(){
                $("#show-btn{{$i}}").click(function(){
                    $("#details{{$i}}").slideToggle();
                    $("#btn-icon{{$i}}").toggleClass("fa-angle-up fa-angle-down");
                });
            });
        </script>
    @endfor
