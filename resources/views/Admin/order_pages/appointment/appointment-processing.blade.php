...
@section('body')
    ...
    <div class="flex justify-between items-center mt-[6vw] mx-[5vw]">
        ...
        <div class="text-[2.2vw] font-bold">Processing</div>
                ...
                <div class="modal-content w-[85vw] h-[45vw] relative">
                    ...
                    <div class="flex justify-between items-center mt-[2vw]">
                        ...
                        <form action="" method="POST">
                            <select class="border-[0.1vw] border-black text-[1.2vw] w-[14vw] h-[2vw]" name="status" id="processing-order-status">
                                <option value="" selected>Select</option>
                                <option value="accepted">Ready to be Delivered</option>
                                <option value="rejected">Rejected</option>
                            </select>

                            <div class="inline-block" id="processing-orders">
