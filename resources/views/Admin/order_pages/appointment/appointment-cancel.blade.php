...
@section('body')
    ...
    <div class="flex justify-between items-center mt-[6vw] mx-[5vw]">
        ...
        <div class="flex items-center w-[30vw] h-[3vw] bg-[#dee2e6] rounded-full">
            <a href="{{ route("cancel-appointments") }}"><div class="w-[15vw] h-[3vw] text-[1.7vw] font-medium flex items-center justify-center rounded-full bg-[#0056b3] text-white">Appointments</div></a>
                    ...
                    <div class="modal-content w-[85vw] h-[45vw] relative">
                        ...
                        <div class="text-[1.3vw] w-[64vw] min-h-[15vw] p-[2vw] font-bold flex">
                            ...
                            <div class="min-w-[24vw]">
                                ...
                                <div class="flex"><div class="w-[9vw]">Reason </div><div class="font-semibold ml-[.5vw]">: {{ $data->reason }}</div></div>
                            </div>
                        </div>
