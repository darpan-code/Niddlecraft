...
@endif
    ...
    <form action="{{ route('otp-verify') }}" method="post">
        @csrf
        <div class="pl-[10vw]">
            <div class="flex flex-col justify-evenly text-[1.7vw] mt-[2vw] h-[32vw] w-[30vw]">

                <div>
                    <div class="font-medium">Enter OTP</div>
                    <input class="w-[30vw] border-gray-400 border-b-[0.2vw] text-[1.5vw] pl-[.5vw]" type="text" name="otp" id="otp">
                    <input hidden value="{{session('otp')}}" type="text" name="otpconfirm">
                    <input hidden value="{{session('id')}}" type="text" name="id">
                </div>
                <div>
