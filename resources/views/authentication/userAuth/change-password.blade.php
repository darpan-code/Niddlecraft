        ...
        <div class="pl-[10vw]">
            <div class="flex flex-col justify-between text-[1.7vw] mt-[2vw] h-[32vw] w-[30vw]">
                <div>
                    ...
                    <input class="w-[30vw] border-gray-400 border-b-[0.2vw] text-[1.5vw] pl-[.5vw]" type="text" name="otp" id="UserID" required>
                    <input hidden value="{{session('otp')}}" type="text" name="otpconfirm">
                    <input hidden value="{{session('email')}}" type="email" name="email">
                </div>
                <div>
                    <div class="font-medium">Password</div>
                    <input class="w-[30vw] border-gray-400 border-b-[0.2vw] text-[1.5vw] pl-[.5vw]" type="password" name="password" required>
                </div>
                <div>
                    <div class="font-medium">Confirm Password</div>
                    <input class="w-[30vw] border-gray-400 border-b-[0.2vw] text-[1.5vw] pl-[.5vw]" type="password" name="password_confirmation" required>
                </div>
                <div>
                    <button class="font-medium text-[2vw] bg-[#0074D6] text-white w-[30vw] h-[4vw] rounded-[0.5vw]" type="submit">Change Password</button>
