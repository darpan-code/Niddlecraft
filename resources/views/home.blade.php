...
@section('body')
    <!-- nav-bar section -->
    <x-nav-bar :userType=$userName :loginStatus=$userLogin :userName=$userName/>
    ...
    <footer class="bg-[#121212] h-[28vw] mt-[14vw] text-white capitalize flex flex-col items-center">
        ...
        <div class="text-[1.2vw] text-[#ffffff85] mt-[5vw]">
            Copyright ©2022 All rights reserved | This website is made by <a class="text-white" href="{{ route('admin-login') }}">Niddlecraft.</a>
        </div>
    </footer>
